...
?> 
        ...
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vistaAsignaturas">Mis asignaturas</a>
          </li>
 ...
 ?>         
       <!-- Menu admin -->
        <ul class="nav nav-pills">
          ...
          <li class="nav-item">
            <a class="nav-link" href="vistaAsignaturaAdmin">Alta Asignatura</a>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="vistaAltaUsuario">Alta de usuarios</a></li>
                  <li><a class="dropdown-item" href="vistaModificarUsuariosAdmin">Modificar usuarios</a></li>
                  <li><a class="dropdown-item" href="vistaEliminarUsuario">Eliminar usuarios</a></li>
