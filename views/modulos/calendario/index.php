...
if ($_SESSION["tipo"]=="ESTUDIANTE"){  
    $sql = "SELECT schedule.*, class.name, class.color FROM enrollment, class, schedule WHERE enrollment.id_student=".$_SESSION['id'] . " and class.id_course = enrollment.id_course and class.id_class = schedule.id_class";
    $req = $bdd->prepare($sql);
    $req->execute();
    $events = $req->fetchAll();
    ...
    $sql = "SELECT schedule.*, class.name, class.color FROM enrollment, class, schedule WHERE class.id_teacher=".$_SESSION['id'] . " and class.id_course = enrollment.id_course and class.id_class = schedule.id_class";
    $req = $bdd->prepare($sql);
    $req->execute();
    $events = $req->fetchAll();
    ...
    $sql = "SELECT schedule.*, class.name, class.color FROM enrollment, class, schedule WHERE class.id_course = enrollment.id_course and class.id_class = schedule.id_class";
    $req = $bdd->prepare($sql);
    $req->execute();
    $events = $req->fetchAll();
}
